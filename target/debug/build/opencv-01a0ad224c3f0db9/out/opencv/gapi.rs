pub mod gapi {
	...
	pub mod prelude {
		pub use super::{DataTrait, DataTraitConst, Detail_ExtractArgsCallbackTrait, Detail_ExtractArgsCallbackTraitConst, Detail_ExtractMetaCallbackTrait, Detail_ExtractMetaCallbackTraitConst, Detail_GArrayUTrait, Detail_GArrayUTraitConst, Detail_GOpaqueUTrait, Detail_GOpaqueUTraitConst, GArgTrait, GArgTraitConst, GArrayDescTrait, GArrayDescTraitConst, GBackendTrait, GBackendTraitConst, GCallTrait, GCallTraitConst, GCompileArgTrait, GCompileArgTraitConst, GCompiledTrait, GCompiledTraitConst, GComputationTrait, GComputationTraitConst, GFrameDescTrait, GFrameDescTraitConst, GFrameTrait, GFrameTraitConst, GFunctorTrait, GFunctorTraitConst, GKernelImplTrait, GKernelImplTraitConst, GKernelPackageTrait, GKernelPackageTraitConst, GKernelTrait, GKernelTraitConst, GMatDescTrait, GMatDescTraitConst, GMatPTrait, GMatPTraitConst, GMatTrait, GMatTraitConst, GOpaqueDescTrait, GOpaqueDescTraitConst, GRunArgTrait, GRunArgTraitConst, GScalarDescTrait, GScalarDescTraitConst, GScalarTrait, GScalarTraitConst, GStreamingCompiledTrait, GStreamingCompiledTraitConst, GTransformTrait, GTransformTraitConst, GTypeInfoTrait, GTypeInfoTraitConst, ImageTrait, ImageTraitConst, MediaFrameTrait, MediaFrameTraitConst, MediaFrame_IAdapterTrait, MediaFrame_IAdapterTraitConst, MediaFrame_ViewTrait, MediaFrame_ViewTraitConst, PolyTrait, PolyTraitConst, RMatTrait, RMatTraitConst, RMat_IAdapterTrait, RMat_IAdapterTraitConst, RMat_ViewTrait, RMat_ViewTraitConst, ScalarTrait, ScalarTraitConst, TextTrait, TextTraitConst, anyTrait, anyTraitConst, use_onlyTrait, use_onlyTraitConst};
	}
